...
if (getenv("DB_DATABASE") || getenv("DB_HOST") || getenv("DB_USERNAME")) {
  ...
  file_put_contents(".env", "DB_HOST="     . parse_url($url, PHP_URL_HOST), FILE_APPEND | LOCK_EX);
  file_put_contents(".env", "DB_USERNAME=" . parse_url($url, PHP_URL_USER), FILE_APPEND | LOCK_EX);
  file_put_contents(".env", "DB_PASSWORD=" . parse_url($url, PHP_URL_PASS), FILE_APPEND | LOCK_EX);
  file_put_contents(".env", "DB_DATABASE=" . ltrim(parse_url($url, PHP_URL_PATH), '/'), FILE_APPEND | LOCK_EX);

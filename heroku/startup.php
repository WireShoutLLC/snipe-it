...
if (getenv("DB_DATABASE") || getenv("DB_HOST") || getenv("DB_USERNAME")) {
  ...
  file_put_contents("setupvars", "DB_HOST="     . parse_url($url, PHP_URL_HOST), FILE_APPEND);
  file_put_contents("setupvars", "DB_USERNAME=" . parse_url($url, PHP_URL_USER), FILE_APPEND);
  file_put_contents("setupvars", "DB_PASSWORD=" . parse_url($url, PHP_URL_PASS), FILE_APPEND);
  file_put_contents("setupvars", "DB_DATABASE=" . ltrim(parse_url($url, PHP_URL_PATH), '/'), FILE_APPEND);
